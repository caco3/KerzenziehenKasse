...
-- Erstellungszeit: 09. Okt 2019 um 23:16
...
CREATE TABLE `articles` (
  ...
  `subtype` enum('normal','floatingCandle','preMade') NOT NULL,
  `name` text,
  `pricePerQuantity` decimal(8,3) DEFAULT NULL,
  `unit` enum('Stk.','g') NOT NULL,
...
INSERT INTO `articles` (`articleId`, `typ`, `subtype`, `name`, `pricePerQuantity`, `unit`, `image1`, `image2`, `image3`) VALUES
(0, 'custom', 'normal', 'Sonstiges', '0.000', 'Stk.', 'custom.png', '', ''),
(1, 'wachs', 'normal', 'Parafin-Wachs', '0.033', 'g', 'colors.png', '', ''),
(2, 'wachs', 'normal', 'Bienenwachs', '0.044', 'g', 'bee.png', '', ''),
(3, 'wachs', 'normal', 'Effektwachs', '1.000', 'Stk.', 'effektwachs.png', '', ''),
(4, 'guss', 'normal', 'Tropfen Bienenwachs', '2.500', 'Stk.', 'drop.png', '', ''),
(5, 'guss', 'normal', 'Kegel', '5.000', 'Stk.', 'kegel.png', '', ''),
(6, 'guss', 'normal', 'Kugel klein', '4.500', 'Stk.', 'kugel.png', '', ''),
(7, 'guss', 'normal', 'Pentakegel klein', '5.000', 'Stk.', 'pentakegel2.png', '', ''),
(8, 'guss', 'normal', 'Rhombenkonus', '5.500', 'Stk.', 'rhombenkonus.png', '', ''),
(9, 'guss', 'normal', 'Sechsstern', '8.000', 'Stk.', 'sechsstern.png', '', ''),
(11, 'guss', 'normal', 'Tanne Parafin', '6.500', 'Stk.', 'tanne.png', '', ''),
(12, 'guss', 'normal', 'Bienenkorb Bienenwachs', '15.500', 'Stk.', 'bienenkorb.png', '', ''),
(13, 'guss', 'normal', 'Pyramide', '8.000', 'Stk.', 'pyramide.png', '', ''),
(14, 'guss', 'normal', 'Pentakegel gross ', '8.500', 'Stk.', 'pentakegel2.png', '', ''),
(15, 'guss', 'normal', 'Sternkegel', '9.000', 'Stk.', 'sternkegel.png', '', ''),
(16, 'guss', 'normal', 'Flamme Parafin', '9.000', 'Stk.', 'flamme.png', '', ''),
(17, 'guss', 'normal', 'Quader hoch', '15.000', 'Stk.', 'quader_gross.png', '', ''),
(19, 'guss', 'normal', 'Quader breit', '16.000', 'Stk.', 'quader_breit.png', '', ''),
(20, 'guss', 'normal', 'Arrangement', '16.000', 'Stk.', 'arrangement.png', '', ''),
(21, 'guss', 'normal', 'Kugel gross', '8.000', 'Stk.', 'kugel.png', '', ''),
(22, 'guss', 'normal', 'Zwölfstern', '8.500', 'Stk.', 'zwoelfstern.png', '', ''),
(23, 'guss', 'normal', 'Tanne Bienenwachs', '10.500', 'Stk.', 'tannenbaum-bienenwachs.png', '', ''),
(24, 'guss', 'normal', 'Flamme Bienenwachs', '15.000', 'Stk.', 'flamme2.png', '', ''),
(25, 'guss', 'floatingCandle', 'Schwimmk. Herzen (6 Stk.)', '4.000', 'Stk.', 'herz.png', '', ''),
(26, 'guss', 'floatingCandle', 'Schwimmk. Enten (6 Stk.)', '4.000', 'Stk.', 'ente.png', '', ''),
(27, 'guss', 'floatingCandle', 'Schwimmk. Fische (6 Stk.)', '4.500', 'Stk.', 'fisch.png', '', ''),
(28, 'guss', 'floatingCandle', 'Schwimmk. Schiffe (6 Stk.)', '3.500', 'Stk.', 'schiff.png', '', ''),
(29, 'guss', 'floatingCandle', 'Schwimmk. Ritterstern (2 Stk.)', '3.500', 'Stk.', 'ritterstern.png', '', ''),
(30, 'guss', 'floatingCandle', 'Schwimmk. Kombi klein (6 Stk.)', '3.500', 'Stk.', 'kombi-klein.png', '', ''),
(31, 'guss', 'floatingCandle', 'Schwimmk. Kombi gross (2 Stk.)', '5.500', 'Stk.', 'kombi-gross.png', '', ''),
(100, 'guss', 'preMade', 'Rosenkugel weiss', '99.000', 'Stk.', 'rosenkugel-weiss.png', '', '');
...
--
ALTER TABLE `basket`
  MODIFY `basketEntryId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT für Tabelle `bookings`
--
ALTER TABLE `bookings`
  MODIFY `bookingId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=531;
COMMIT;
